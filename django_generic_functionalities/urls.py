"""
URL configuration for django_generic_functionalities project.
...
schema_view = get_schema_view(
   openapi.Info(
      ...
      contact=openapi.Contact(email="manavshah1011.ms@gmail.com"),      
   ),
   public=True,
...
urlpatterns = [
    ...
    path('auth/', include('TWOFA_AUTH.urls'),name='auth'),
